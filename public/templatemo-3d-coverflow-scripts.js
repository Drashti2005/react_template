        ...
        const imageData = [
            {
                ...
                description: "The Statue of Unity stands tall as the world’s tallest statue"
            },
            {
                title: "Rann OF Kutchh",
                description: "A dazzling salt desert, the Rann of Kutch glows pure white under the sun and moon."
            },
            {
                title: "Rani ke Vav",
                description: "Rani ki Vav is not just a stepwell, but a masterpiece of devotion, architecture, and heritage."
            },
            {
                title: "Gir Wildlife Sanctuary",
                description: "The home to the last wild population of the Asiatic Lion."
            },
            {
                title: "Dwarka Temple",
                description: "The Magical town formed by Lord DwarkaDhis (Shree Krishna)"
            },
            {
                title: "Smriti Van Earthquake Museum",
                description: "The memorial spans an impressive 170 acres on the historically significant Bhujiyo Dungar."
            },
            {
                title: "Laxmi vilas Palace",
                description: "This is the largest private home built till date"
            }
        ];
